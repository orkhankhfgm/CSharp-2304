        ...
        static void Main(string[] args)
        {
            /*
             Homework:
              ...
              Id, Barcode, Brand, Model, BuyPrice, SellPrice, OfferPrice, CPU, Ram, GraphicCard, CreateDate, CreateUser, EditDate, EditUser, IsDeleted, DeleteDate, DeleteUser;
              
              Tv class'ında olacaq propertylər: 
              Id, Barcode, Brand, Model, BuyPrice, SellPrice, OfferPrice, IsSmartTv, HasHDMI, Resolution, CreateDate, CreateUser, EditDate, EditUser, IsDeleted, DeleteDate, DeleteUser;
