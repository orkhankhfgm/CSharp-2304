...
namespace PastHomeworks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    {
            //        int result = i * x;
            //        Console.Write("{0}*{1}={2}\t", i, x, result);
            //    }
            //    Console.WriteLine();
            //}
            #endregion
            ...
            //{
            //    counter++;
            //    Console.WriteLine("{0}. Cəhdiniz! Zəhmət olmasa rəqəmi təxmin edin: ", counter);
            //    estimate = int.Parse(Console.ReadLine());
            //} while (estimate != generatedNum);

            //Console.WriteLine("{0}. Cəhdinizdə düzgün rəqəmi tapdınız!", counter);
            #endregion
